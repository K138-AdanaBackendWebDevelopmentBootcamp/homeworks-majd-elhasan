...
public class Main {
    public static void main(String[] args) {
        ...
        List<Course> courseList01 = new ArrayList<>(Arrays.asList(Course01, Course02));
        List<Course> courseList02 = new ArrayList<>(Arrays.asList(Course03, Course04));
        List<Course> courseList03 = new ArrayList<>(Arrays.asList(Course05, Course06));
        ...
        Student s1=new Student("Nur",LocalDate.of(1995,2,27),"inegöl","erkek");
