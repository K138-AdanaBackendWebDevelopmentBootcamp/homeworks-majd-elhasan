...
import dev.patika.SchoolManagementSystem04.controllers.Interface.IBaseController;
...
public class CourseController implements IBaseController<Course> {
    ...
    public ResponseEntity<Course> updateById(@RequestBody Course course,@PathVariable int id) {
        return new ResponseEntity<>(iCourseService.updateById(course,id),HttpStatus.OK);
    }
